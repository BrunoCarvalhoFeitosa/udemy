...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
    ...
    return (
        <Button
            ...
            size={size}
            className={cn(
                "py-2 px-4 h-14 w-14 border-0 rounded-full bg-gray-300 hover:bg-gray-400/40 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed",
                orientation === "horizontal"
                ? "-bottom-20 right-16"
