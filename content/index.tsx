export const galleries = [
    {
        ...
        title: "Domine frameworks como React.js, Angular.js e Vue.js",
        src: "/image/image-hero-01.jpg",
        content: <div className="flex flex-col gap-4 bg-[#F5F5F7] p-8 md:p-14 rounded-3xl mb-4">
            <p className="mx-auto max-w-3xl mb-4 text-neutral-600 text-base md:text-2xl">
            ...
            <p className="mx-auto max-w-3xl mb-4 text-neutral-600 text-base md:text-2xl">
                <strong className="text-neutral-700">Angular.js:</strong> É um framework JavaScript desenvolvido pelo Google para criar 
            ...
            <p className="mx-auto max-w-3xl text-neutral-600 text-base md:text-2xl">
    ...
    },
    {
        ...
        content: <div className="flex flex-col gap-4 bg-[#F5F5F7] p-8 md:p-14 rounded-3xl mb-4">
            <p className="mx-auto max-w-3xl mb-8 text-neutral-600 text-base md:text-2xl">
            ...
            <p className="pt-7 text-neutral-600 text-left text-base md:text-2xl">
